...
const Assignment = mongoose.model('AssignmentInspect5', assignmentSchema, 'assignments');
...
(async () => {
  try {
    ...
    questions.slice(0, 5).forEach((q, i) => console.log(`    Q${q.questionId}: ${(q.prompt||q.question).slice(0,80)}`));
