...
(async () => {
  try {
    ...
    const res = await Assignment.updateOne(
      ...
      {
        $set: {
          title: 'ASSIGNMENT 2 – Study Material (15 Practical Networking Topics)',
          description: 'Study material covering practical networking topics with explanations and commands.',
          topics,
          questions: [],
          passingPercentage: 0
        }
